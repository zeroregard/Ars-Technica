...
const { getGithubIssues, createGithubIssue } = require('./services/github');
const { fetchCurseforgeComments } = require('./services/curseforge');
const { isBugReport } = require('./services/analyzer');
